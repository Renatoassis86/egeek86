    ...
    <div className="min-h-screen bg-[var(--color-bg-canvas)] text-[var(--color-text-primary)]">
      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8 py-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
          ...
          <div className="flex flex-col gap-6">
            {/* Widget 1: Divisão de Inteligência */}
            <div className="rounded-[var(--radius-xl)] border-2 border-amber-500/40 bg-amber-500/5 p-5 shadow-lg hover:shadow-2xl transition-all duration-300 hover:border-amber-400 group">
            ...
            {/* Widget 2: Arkos Insight */}
            <div className="rounded-[var(--radius-xl)] border-2 border-amber-500/40 bg-gradient-to-b from-[#201C18] via-[#161311] to-[#0B0908] text-white p-6 shadow-2xl relative overflow-hidden group hover:border-amber-400 transition-all duration-300">
              ...
              <div className="relative z-10 flex flex-col gap-3">
                ...
                <div className="flex items-center gap-3 pt-3 border-t border-amber-900/40 mt-1">
